...
@section('title', 'Agregar Item - Chankas Car')

@section('content_header')
    <h1>Agregar Nuevo Item al Inventario</h1>
@stop
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="nombre" 
                                   name="nombre" 
                                   placeholder="Ej: Filtro de aceite, Manguera de freno" 
                                   value="{{ old('nombre') }}"
                                   required>
                            @error('nombre')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('unidad_medida') is-invalid @enderror" 
                                ...
                                <option value="kilo" {{ old('unidad_medida') == 'kilo' ? 'selected' : '' }}>Kilogramo</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                              ...
                              name="descripcion" 
                              rows="3"
                              placeholder="Descripción detallada del item...">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('tipo_stock') is-invalid @enderror" 
                                    ...
                                    name="tipo_stock" 
                                    required>
                                <option value="contable" {{ old('tipo_stock') == 'contable' ? 'selected' : '' }}>Contable (se descuenta automático)</option>
                                <option value="pregunta" {{ old('tipo_stock') == 'pregunta' ? 'selected' : '' }}>Pregunta (se pregunta si hay)</option>
                            </select>
                            @error('tipo_stock')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            @enderror
                            <small class="form-text text-muted">Contable: piezas. Pregunta: mangueras, cables</small>
                        </div>
                    </div>
                </div>
